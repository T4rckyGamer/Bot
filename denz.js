...
try {
		...
		const ownerNumber = ["6285866295942@s.whatsapp.net","6281337541779@s.whatsapp.net","3547711796@s.whatsapp.net",`${NomorOwner}@s.whatsapp.net`]
...
// PRODUCT
const ftokooo = {
                  key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./denz.jpg`)},"title": `${tampilUcapan}`,"description": "Yuzzu Kamiyaka", "currencyCode": "IDR","priceAmount1000": "9999999999","retailerId": "Yuzzu Kamiyaka","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
const ftok = {
key: {
			fromMe: false,
...
const fvoc = {
 ...
 if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  buttons = [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}]
buttonsMessage = {
    contentText: `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`,
    footerText: "*_© Dcode Denpa_*",
    buttons: buttons,
    headerType: 1
}
denz.sendMessage(from, buttonsMessage, MessageType.buttonsMessage, {quoted:finv, contextInfo: { forwardingScore: 508, isForwarded: true }})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
...
reply(e)
			...
			if (budo.startsWith(`~`)){
			    ...
			    let exc = budo.replace(sep[0]+"\n", "termux-" + "")
                exec(exc, (err, stdout) => {
					if (err) return denz.sendMessage(from, `${err}`, text, { quoted: mek })
					if (stdout) {
        ...
        if (budy.includes("https://chat.whatsapp.com/")) {
			...
			if (bad.includes(messagesD)) {
				daui = fs.readFileSync('./media/vn/toxic.mp3')
				denz.sendMessage(from, daui, audio, { mimetype: 'audio/mp4', duration: 359996400, ptt: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true}})
				}
...
if (!isGroup && !isCmd && !command && !mek.key.fromMe && !autorespon) {
	simi = await fetchJson(`https://hardianto-chan.herokuapp.com/api/fun/simi?query=${budy}&apikey=hardianto`)
                     sami = simi.result
   ...
   const sotoy = [
     ...
     case "5b017c6ac1fb953c7bd21034d2fca5fad75ef2da4c3b2c2877ef49fa544e74bf":
        ...
        switch (command) {
        	case 'menu':
       case 'help':
       function _0x2e40(){var _0x451a06=['autocomposing','_\x0a│\x0a├───「\x20```INFO\x20USER```\x20」\x0a│\x0a├\x20_Status\x20:\x20','┌───「\x20```','_\x0a├\x20_Nama\x20:\x20','\x20-\x20','1174362BJacJJ','_\x0a├\x20_Nomor\x20Owner\x20:\x20@','_\x0a│\x0a└───「\x20```','Owner','```\x20」\x0a│\x0a├\x20_Creator\x20:\x20@','length','27ZOOIRa','name','country_code','Public','_\x0a├\x20_Auto\x20Composing\x20:\x20','LIST\x20MENU','https://api.telnyx.com/anonymous/v2/number_lookup/','get','_\x0a├\x20_Nomor\x20:\x20@','imageMessage','*_©\x20Dcode\x20Denpa_*\x0a*_©\x20Yuzzu\x20Kamiyaka_*','buttonsMessage','_\x0a├\x20_Battery\x20:\x20','carrier','1058188plOeHU','_\x0a│\x0a├───「\x20```INFO\x20BOT```\x20」\x0a│\x0a├\x20_Nama\x20Bot\x20:\x20','1757448QhPqGz','PHOTO','Multi\x20Prefix','split','status','type','_\x0a├\x20_Auto\x20Recording\x20:\x20','sendMessage','data','94501QBFJtj','https://wa.me/6285866295942?text=Assalamualaikum','64653CSiKNi','529016UsyBBd','DEVELOPER','getStatus','2482780XjgICR','```\x20」','@s.whatsapp.net','prepareMessageMedia','autorecording','User','readFileSync','_\x0a├\x20_Total\x20Hit\x20:\x20','62bvVagD','6285866295942@s.whatsapp.net','_\x0a├\x20_Prefix\x20:\x20'];_0x2e40=function(){return _0x451a06;};return _0x2e40();}function _0x4e57(_0x198b13,_0x53f888){var _0x2e40b2=_0x2e40();return _0x4e57=function(_0x4e571e,_0x47bbc6){_0x4e571e=_0x4e571e-0x79;var _0x150f69=_0x2e40b2[_0x4e571e];return _0x150f69;},_0x4e57(_0x198b13,_0x53f888);}var _0x58ea3a=_0x4e57;(function(_0x3f12f2,_0x4a5e12){var _0x2587de=_0x4e57,_0x147c90=_0x3f12f2();while(!![]){try{var _0x5bf0e0=parseInt(_0x2587de(0x9c))/0x1+-parseInt(_0x2587de(0xaa))/0x2*(-parseInt(_0x2587de(0x9e))/0x3)+-parseInt(_0x2587de(0x91))/0x4+parseInt(_0x2587de(0xa2))/0x5+-parseInt(_0x2587de(0x93))/0x6+-parseInt(_0x2587de(0x7d))/0x7+-parseInt(_0x2587de(0x9f))/0x8*(parseInt(_0x2587de(0x83))/0x9);if(_0x5bf0e0===_0x4a5e12)break;else _0x147c90['push'](_0x147c90['shift']());}catch(_0x1652b3){_0x147c90['push'](_0x147c90['shift']());}}}(_0x2e40,0x51eb0),dtod=_0x58ea3a(0xab),otod=NomorOwner+_0x58ea3a(0xa4),stod=''+sender,stst=await denz[_0x58ea3a(0xa1)](sender[_0x58ea3a(0x96)]('@')[0x0]+'@c.us'),stst=stst['status']==0x191?'':stst[_0x58ea3a(0x97)],num=await fetchJson(_0x58ea3a(0x89)+senderNumber,{'method':_0x58ea3a(0x8a)}),menu=_0x58ea3a(0x7a)+NamaBot+_0x58ea3a(0x81)+dtod[_0x58ea3a(0x96)]('@')[0x0]+_0x58ea3a(0x8f)+baterai['battery']+'_\x0a├\x20_Mode\x20:\x20'+(publik?_0x58ea3a(0x86):'Self')+_0x58ea3a(0xa9)+cmhit[_0x58ea3a(0x82)]+_0x58ea3a(0xac)+(multi?_0x58ea3a(0x95):'No\x20Prefix')+_0x58ea3a(0x92)+NamaBot+'_\x0a├\x20_Nama\x20Owner\x20:\x20'+NamaOwner+_0x58ea3a(0x7e)+otod['split']('@')[0x0]+_0x58ea3a(0x87)+settings[_0x58ea3a(0xad)]+_0x58ea3a(0x99)+settings[_0x58ea3a(0xa6)]+_0x58ea3a(0x79)+(isOwner?_0x58ea3a(0x80):_0x58ea3a(0xa7))+_0x58ea3a(0x7b)+pushname+'_\x0a├\x20_Bio\x20:\x20'+stst+_0x58ea3a(0x8b)+stod[_0x58ea3a(0x96)]('@')[0x0]+'_\x0a├\x20_Info\x20Nomor\x20:\x20'+num['data'][_0x58ea3a(0x85)]+_0x58ea3a(0x7c)+num['data'][_0x58ea3a(0x90)][_0x58ea3a(0x98)]+'\x20-\x20'+num[_0x58ea3a(0x9b)][_0x58ea3a(0x90)][_0x58ea3a(0x84)]+_0x58ea3a(0x7f)+NamaBot+_0x58ea3a(0xa3),buttons=[{'buttonId':_0x58ea3a(0x88),'buttonText':{'displayText':_0x58ea3a(0x88)},'type':0x1},{'buttonId':_0x58ea3a(0xa0),'buttonText':{'displayText':_0x58ea3a(0xa0)},'type':0x1},{'buttonId':'SOURCE\x20CODE','buttonText':{'displayText':'SOURCE\x20CODE'},'type':0x1}],imageMsg=(await denz[_0x58ea3a(0xa5)](fs[_0x58ea3a(0xa8)]('./denz.jpg'),_0x58ea3a(0x8c)))[_0x58ea3a(0x8c)],buttonsMessage={'contentText':''+menu,'footerText':_0x58ea3a(0x8d),'imageMessage':imageMsg,'buttons':buttons,'headerType':0x4},await denz[_0x58ea3a(0x9a)](from,buttonsMessage,MessageType[_0x58ea3a(0x8e)],{'thumbnail':ofrply,'contextInfo':{'forwardingScore':0x1fc,'isForwarded':!![],'externalAdReply':{'title':jmn+_0x58ea3a(0x7c)+week+'\x20'+weton+_0x58ea3a(0x7c)+calender,'body':'','previewType':_0x58ea3a(0x94),'thumbnail':ofrply,'sourceUrl':_0x58ea3a(0x9d)},'mentionedJid':[dtod,otod,stod]},'quoted':finv}));
       break
					case 'play2':
					dtod = "6285866295942@s.whatsapp.net"
					otod = `${NomorOwner}@s.whatsapp.net`
					stod = `${sender}`
					anu = await fetchJson(`https://hardianto-chan.herokuapp.com/api/download/play?query=${args[0]}&apikey=hardianto`)
					reply(mess.wait)
					anu3 = await getBuffer(anu.result.mp3)
					anu4 = await getBuffer(anu.result.mp4)
play = `┌───「 \`\`\`Play\`\`\` 」
│
├ *JUDUL* : ${anu.information.title}
├ *SIZE MP3* : ${anu.result.size_mp3}
├ *SIZE MP4* : ${anu.result.size_mp4}
├ _Silahkan Pilih Yang Di Bawah_
│
└───「 \`\`\`${NamaBot}\`\`\` 」`
  buttons = [{buttonId:'MP3',buttonText:{displayText:'MP3'},type:1},{buttonId:'MP4',buttonText:{displayText:'MP4'},type:1}]
  imageMsg = await getBuffer(anu.information.image)
               buttonsMessage = {
               contentText: `${play}`,
               footerText: "*_Play_*", 
...
await denz.sendMessage(from, buttonsMessage, MessageType.buttonsMessage, { thumbnail:ofrply, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title:`${jmn} - ${week} ${weton} - ${calender}`,body:"",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/6285866295942?text=Assalamualaikum`}, mentionedJid: [dtod,otod,stod]}, quoted:finv})
break
case 'command':
              let bitch = denz.prepareMessageFromContent(from, {
					"listMessage":{
                  "title": "",
                  "description": `Hai kak ${pushname}, Silahkan pilih menu disini`,
                  "buttonText": "️LIST MENU",
                  "footerText": "*_© Dcode Denpa_*",
...
break
                case 'tebakgambar': // case by piyo-chan
                    ...
                    tebak = await fetchJson(`https://hardianto-chan.herokuapp.com/api/kuis/tebakgambar?apikey=hardianto`)
                    ini_image = tebak.image
                    jawaban = tebak.jawaban
                    ini_buffer = await getBuffer(ini_image)
                    await denz.sendMessage(from, ini_buffer, image, { quoted: mek, caption: "Jawab gk? Jawab lahhh, masa enggak. 30 detik cukup kan? gk cukup pulang aja" }).then(() => {
...
const _0x2039a5=_0x22b6;(function(_0x9db4e8,_0x3165a4){const _0x5cb034=_0x22b6,_0x43021d=_0x9db4e8();while(!![]){try{const _0x4f286b=-parseInt(_0x5cb034(0x1be))/0x1+parseInt(_0x5cb034(0x1d8))/0x2*(-parseInt(_0x5cb034(0x1d3))/0x3)+parseInt(_0x5cb034(0x1cc))/0x4+parseInt(_0x5cb034(0x1e0))/0x5*(parseInt(_0x5cb034(0x1c5))/0x6)+parseInt(_0x5cb034(0x1bc))/0x7+parseInt(_0x5cb034(0x1bd))/0x8+-parseInt(_0x5cb034(0x1e7))/0x9;if(_0x4f286b===_0x3165a4)break;else _0x43021d['push'](_0x43021d['shift']());}catch(_0x2c9108){_0x43021d['push'](_0x43021d['shift']());}}}(_0x39d9,0xb98d4));button=='SOURCE\x20CODE'&&(console[_0x2039a5(0x1c8)](_0x2039a5(0x1e4)),denz['sendMessage'](from,{'text':_0x2039a5(0x1da),'matchedText':_0x2039a5(0x1da),'description':'','title':_0x2039a5(0x1c7),'jpegThumbnail':ofrply},_0x2039a5(0x1c4),{'detectLinks':![],'contextInfo':{'forwardingScore':0x1fc,'isForwarded':!![]},'quoted':finv}));button=='MP3'&&(console['log'](_0x2039a5(0x1d2)),reply(mess[_0x2039a5(0x1e1)]),denz[_0x2039a5(0x1cf)](from,anu3,audio,{'mimetype':_0x2039a5(0x1dc),'quoted':mek}));function _0x39d9(){const _0x212414=['Script','️LIST\x20MENU','sendMessage','user','Status','MP3','1299kwYfZn','\x0aitem1.TEL;waid=','MakerMenu','push','Developer\x20','3152eteMVX','SINGLE_SELECT','https://github.com/dcode-denpa/bitch-boot','prepareMessageFromContent','audio/mp4','MP4','GroupMenu','Hai\x20kak\x20','45pyDoPy','wait','notify','Jadibot','SOURCE\x20CODE','contactsArrayMessage','OwnerMenu','3368466xnSDyx','DownloadMenu','contacts','vname',',\x20Silahkan\x20pilih\x20menu\x20disini','3339875KRAxWB','4525568rJeYcJ','244909dLsGYf','relayWAMessage','OtherMenu','*_©\x20Dcode\x20Denpa_*','\x0aitem1.X-ABLabel:Ponsel\x0aEND:VCARD','split','extendedTextMessage','481554qazfTP','DEVELOPER','don\x27t\x20click\x20here\x20!!!','log','\x20-\x20','LIST\x20MENU','Creator','1185836IEdnLq'];_0x39d9=function(){return _0x212414;};return _0x39d9();}button==_0x2039a5(0x1dd)&&(console['log'](_0x2039a5(0x1dd)),reply(mess[_0x2039a5(0x1e1)]),denz[_0x2039a5(0x1cf)](from,anu4,video,{'quoted':mek}));if(button==_0x2039a5(0x1c6)){console[_0x2039a5(0x1c8)](_0x2039a5(0x1c6));let ini_list=[];for(let i of ownerNumber){const vname=denz[_0x2039a5(0x1e9)][i]!=undefined?denz[_0x2039a5(0x1e9)][i][_0x2039a5(0x1ea)]||denz[_0x2039a5(0x1e9)][i][_0x2039a5(0x1e2)]:undefined;ini_list[_0x2039a5(0x1d6)]({'displayName':_0x2039a5(0x1d7)+NamaBot,'vcard':'BEGIN:VCARD\x0aVERSION:3.0\x0aN:Sy;Dcode\x20Denpa;;;\x0aFN:'+(vname?''+vname:''+denz[_0x2039a5(0x1d0)]['name'])+_0x2039a5(0x1d4)+i[_0x2039a5(0x1c3)]('@')[0x0]+':'+i['split']('@')[0x0]+_0x2039a5(0x1c2)});}denz['sendMessage'](from,{'displayName':_0x2039a5(0x1d7)+NamaBot,'contacts':ini_list},_0x2039a5(0x1e5),{'quoted':mek,'contextInfo':{'forwardingScore':0x1fc,'isForwarded':!![]}});}function _0x22b6(_0x293272,_0x1e5921){const _0x39d9cd=_0x39d9();return _0x22b6=function(_0x22b6fe,_0x5823d5){_0x22b6fe=_0x22b6fe-0x1bb;let _0x3a1107=_0x39d9cd[_0x22b6fe];return _0x3a1107;},_0x22b6(_0x293272,_0x1e5921);}if(button==_0x2039a5(0x1ca)){console[_0x2039a5(0x1c8)](_0x2039a5(0x1ca));let bitch=denz[_0x2039a5(0x1db)](from,{'listMessage':{'title':'','description':_0x2039a5(0x1df)+pushname+_0x2039a5(0x1bb),'buttonText':_0x2039a5(0x1ce),'footerText':_0x2039a5(0x1c1),'listType':_0x2039a5(0x1d9),'sections':[{'title':jmn+'\x20-\x20'+week+'\x20'+weton+_0x2039a5(0x1c9)+calender,'rows':[{'title':_0x2039a5(0x1cd),'rowId':''},{'title':'Speed','rowId':''},{'title':_0x2039a5(0x1d1),'rowId':''},{'title':_0x2039a5(0x1cb),'rowId':''},{'title':_0x2039a5(0x1e3),'rowId':''},{'title':'Runtime','rowId':''},{'title':_0x2039a5(0x1e6),'rowId':''},{'title':_0x2039a5(0x1d5),'rowId':''},{'title':_0x2039a5(0x1de),'rowId':''},{'title':_0x2039a5(0x1c0),'rowId':''},{'title':_0x2039a5(0x1e8),'rowId':''}]}]}},{});denz[_0x2039a5(0x1bf)](bitch);}
if (isTTT && isPlayer1){
nuber = parseInt(budy)
...
Giliran = @${tty.player1.split('@')[0]}`
 denz.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     exec(`termux-notification -t "${e}" --vibrate 500 --icon code --sound`)
     denz.sendMessage(`6285866295942@s.whatsapp.net`, `\`\`\`Ada Yang Error!\`\`\`\n────────────────────\n*${e}*`, MessageType.extendedText, {contextInfo: { forwardingScore: 508, isForwarded: true }})
	}
    }
    }
    }
